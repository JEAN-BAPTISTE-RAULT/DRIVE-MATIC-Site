...
- **Mise en oeuvre — integration du 2026-08-25** ([ADR-024](../.claude/decisions/024-mutualisation-formulaire-simple.md)) : le node « Devenir partenaire » passe du bundle `partner` (retire) au bundle mutualise `simple_form`, qui porte desormais aussi « Demande de création de compte » (F12, page `/user/login`) — les deux nodes **partagent temporairement ce meme webform**, en attendant la creation du webform dedie a la demande de compte.
