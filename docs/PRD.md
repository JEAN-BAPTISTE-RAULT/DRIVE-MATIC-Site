...
**Criteres d'acceptation** :
- [x] Le tarif remise applique = remise commerciale du partenaire (back-office, `field_discount_rate`). `[ ]` remise « exceptionnelle » saisie par Drive Matic pour ce devis precis — l'entite `quote_equipment_line` existe desormais (ADR-033, 2026-09-01), mais aucune interface d'edition de cette remise par ligne n'est implementee (F15).
