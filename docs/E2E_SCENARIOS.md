...
En desktop (≥992px), la grille 3 colonnes du formulaire donne desormais
Siret/TVA/Raison sociale sur une ligne, Adresse/Complement sur la suivante,
Code postal/Ville sur la derniere (`dm-form-row-start` ajoute sur Code
postal) ; en mobile, tous les champs restent empiles, inchange. Les 2
